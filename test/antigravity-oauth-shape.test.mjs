...
test("routes each Gemini family and effort to its current Antigravity model id", () => {
  const cases = [
    ...
    ["gemini-3.8-flash", undefined, "gemini-3.8-flash-medium", 4000, 65536],
    ["gemini-3.8-flash", "low", "gemini-3.8-flash-low", 1000, 65536],
    ["gemini-3.8-flash", "medium", "gemini-3.8-flash-medium", 4000, 65536],
    ["gemini-3.8-flash", "high", "gemini-3.8-flash-high", -1, 65536],
